...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var situaciones = [
        ...
        { numero: 4, titulo: "Sabés lo que hacés, pero te cuesta destacar tu diferencial", texto: "Conocés tu producto o servicio mejor que nadie. Sin embargo, cuando tenés que contar qué hacés, para quién es o por qué deberían elegirte, no sabés por dónde empezar.", imagen: "img/situations/sit 4.webp" }
    ];
